  ...
  return (
    ...
    >
      ...
      <p className="mb-5 text-base text-white">
        Get professional consultation and competitive pricing for your
        industrial needs.
      </p>
      <div>
        <a
          href="/contact"
          className="inline-block mb-4 h-[50px] w-full cursor-pointer rounded-md bg-secondary text-center text-sm font-medium text-white transition duration-300 ease-in-out hover:bg-[#0BB489] hover:bg-opacity-90 leading-[50px]"
        >
          Contact Us Now
        </a>
      </div>
      <p className="text-sm font-medium text-white">
        Our experts are ready to assist you with technical specifications and
        quotes.
      </p>
